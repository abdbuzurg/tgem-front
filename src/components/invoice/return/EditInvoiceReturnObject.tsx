...
export default function EditInvoiceReturnObject({
  ...
  const materialCostQuery = useQuery<IMaterialCost[], Error, IMaterialCost[]>({
    ...
    queryFn: () => getMaterialCostsInLocation(selectedMaterial.value, editInvoiceReturnObject.returnerType, editInvoiceReturnObject.returnerID),
  ...
  const materialAmountQuery = useQuery<number, Error, number>({
    ...
    queryFn: () => getMaterialAmountInLocation(selectedMaterialCost.value, editInvoiceReturnObject.returnerType, editInvoiceReturnObject.returnerID,),
