...
export default function AddInvoiceReturnTeam({
  ...
  const materialCostQuery = useQuery<IMaterialCost[], Error, IMaterialCost[]>({
    ...
    queryFn: () => getMaterialCostsInLocation(selectedMaterial.value, addInvoiceReturnTeamData.returnerType, addInvoiceReturnTeamData.returnerID),
  ...
  const materialAmountQuery = useQuery<number, Error, number>({
    ...
    queryFn: () => getMaterialAmountInLocation(selectedMaterialCost.value, addInvoiceReturnTeamData.returnerType, addInvoiceReturnTeamData.returnerID,),
