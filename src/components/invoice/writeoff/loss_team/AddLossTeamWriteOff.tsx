...
export default function AddLossTeamWriteOff({
  setShowAddModal,
}: Props) {
  ...
  const onMutationSubmit = () => {
    ...
    createInvoiceWriteOffMutation.mutate({
      ...
      items: invoiceMaterials.map<InvoiceWriteOffItem>(val => ({ materialID: val.materialID, amount: val.amount,
        notes: val.notes,
      }))
    })
  }
