...
export default function WriteOffObject() {
  ...
  const tableDataQuery = useInfiniteQuery<InvoiceWriteOffPagianted, Error>({
    queryKey: ["invoice-writeoff", "writeoff-object"],
    queryFn: ({ pageParam }) => getPaginatedInvoiceWriteOff({ pageParam }, "writeoff-object"),
  ...
  return (
    <main>
      <div className="mt-2 px-2 flex justify-between">
        <span className="text-3xl font-bold">Акт списания с объекта</span>
        <div>
