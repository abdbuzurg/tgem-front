...
import { IMJDObjectCreate, IMJDObjectGetAllResponse, IMJDObjectPaginated, createMJDObject, deleteMJDObject, getPaginatedMJDObjects, updateMJDObject } from "../../../services/api/mjd"
