...
const report = [
  ...
  },
  {
    category: "Кадр",
    pages: [
      { name: "Отчет по МОРФО", type: REPORT_HR_ATTENDANCE },
    ]
  },
]
